...
import {getChangeAction,getAddAction,getDeleteAction,getLOADDATA} from "./store/actionCreate.js"
...
class App extends Component{
		constructor(props){
			...
			*/
			...
			store.subscribe(()=>//改变组件里面的state
				this.setState(
					store.getState()//store.getState()获取最新的store数据
				)
			)
		} 
